...
class Game:
    def __init__(self):
        self.tk = Tk()
        self.tk.title("Mr. Stick Man Rances for the Exit")
        ...
        self.sprites = []
        self.running = True
        self.game_over_text = self.canvas.create_text(250, 250, text='Congratulation!!!!',state='hidden',
                                font=('', 43), fill='gold')
    ...
    def move(self):
        ...
        for sprite in self.game.sprites:
            ...
            if top and self.y < 0 and collided_top(co, sprite_co):
                self.y = -self.y
                top = False
            if bottom and self.y > 0and collided_bottom(self.y, co, sprite_co):
